...
class PostPlayMetabox {
    ...
    public function save_meta_box($post_id) {
        ...
        if ($the_value == '1') {
            $response_obj = $connector->postJob($post_id, $_POST['post_title'], $_POST['content'], $_POST['pref_agent'], $_POST['pref_gender']);
            ...
            if ($response_obj->status == 'success') {
                ...
                if(isset($resp_data->alert) && !empty($resp_data->alert))
                    set_transient("_postplay_error_msg", ($resp_data->alert), 60);
